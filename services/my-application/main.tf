...
module "secrets" {
	source = "github.com/1Mill/experiment-deploy-docker-to-aws-elasticbeanstalk.git//terraform/sops"
...
module "production" {
	source = "github.com/1Mill/experiment-deploy-docker-to-aws-elasticbeanstalk.git//terraform/aws/elasticbeanstalk/docker"
	environment = [
